...
* _**[client][client-app-dir]**_ - [🎭] - _Shambhala frontend service_
    interacting with the _**user**_, _**[host application][host-app-dir]**_
    and _**[server][server-app-dir]**_. Responsible for storing data in
    [Web Storage], key derivation, encryption/dectyption of secrets and,
    most importantly, inspecting and signing transactions.
