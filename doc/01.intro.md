...
* _**server**_ - 🏢 - _Shambhala backend service_ interacting with
    ...
    encryption/decryption of secrets, checking permissions, checking
    constraints and signing transactions.
...
* _**client**_ - 🎭:
    ...
    - confirm account creation and request funding from
        the _**host application**_
...
## 3. **[Variant B]** - Onboarding with an account association
