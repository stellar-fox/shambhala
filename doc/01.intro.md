...
* _server_:
    ...
    - fund `G_PUBLIC` with minimal needed amount (_friendbot_ on _[test net]_,
        _sfox service_ on _public net_)
...
* _server_:
    ...
    - `fundedBySfox` flag present in storage
