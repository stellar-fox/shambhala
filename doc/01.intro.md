...
* _**[host application][host-app-dir]**_ - [💻] - Any application that operates on / interacts
    with the _[stellar] network_ and needs a robust [transaction] signing
...
* _**[server][server-app-dir]**_ - [🏢] - _Shambhala backend service_
    interacting with the _**client**_. Responsible for storing data
    in database, key validation, encryption/decryption of secrets,
