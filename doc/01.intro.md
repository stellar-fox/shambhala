...
* _**host application**_ - 💻:
    ...
    - is able to construct appropriate transaction
...
* _**host application**_ - 💻:
    ...
    - _shambhala_ is asked to generate **signed** transaction allowing
...
* _**client**_ - 🎭:
    ...
    - return signed transaction to a _**host application**_
...
* _**host application**_ - 💻:
    ...
    - _shambhala_ is asked to generate transaction allowing
        `S_PUBLIC` and `C_PUBLIC` to sign on behalf of `G_PUBLIC`:
...
* _**client**_ - 🎭:
    ...
    - return created transaction to the _**host application**_
...
* Safety of a described scheme is build on a following foundations:
    ...
    - all communication between _**host application**_ and _**client**_
        is done within browser's and using [cross-origin communication] methods
