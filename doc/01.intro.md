...
Opt-out from _shambhala service_ on _**user**_ demand can't be prevented
...
* _**client**_ - 🎭 - _Shambhala frontend service_ interacting
...
* _**server**_ - 🏢 - _Shambhala backend service_ interacting with
